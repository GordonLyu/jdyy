        ...
        <div class="musicList">
            ...
            <div class="control">
                ...
                <div class="player">
                    ...
                    <button @click="play(true)" v-show="show"><span class="fa-play"></span> </button>
                    <button @click="pause(true)" v-show="!show"><span class="fa-pause"></span> </button>

                    <button @click="next"><span class="fa-step-forward"></span></button>
                    <div class="quiet">
                        <button @click="mute(true)" v-show="!muted"><span class="fa-volume-up"></span></button>
                        <button @click="mute(false)" v-show="muted"><span class="fa-volume-off"></span></button>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            ...
            volume: 1,
            audioSrc: [
                "http://localhost:8080/music/audio/mid_49.mp3"
            ],
            value: 0,
            timer: '',
            show: true,
